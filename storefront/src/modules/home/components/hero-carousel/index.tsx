...
import { shouldShowCarouselButton, hasVisibleButtons } from "@/lib/util/carousel-utils"
                  ...
                  <div className="mx-auto px-4 py-[40px] sm:py-[60px] md:py-[100px] xl:pt-[170px] md:max-w-5xl md:px-6 md:ml-0 xl:mx-auto h-full w-full flex flex-col">
                    ...
                    {hasVisibleButtons(item.primary_button_text, item.primary_button_url, item.secondary_button_text, item.secondary_button_url, item.primary_button_active, item.secondary_button_active) && (
                      <div className="flex flex-col min-[376px]:flex-row justify-center items-center md:justify-start gap-3">
                        {shouldShowCarouselButton(item.primary_button_text, item.primary_button_url, item.primary_button_active) && (
                          <div className="flex justify-center items-center text-center px-3 py-4 bg-gray-300 h-9 w-[180px] rounded-full animate-pulse" />
                        )}
                        {shouldShowCarouselButton(item.secondary_button_text, item.secondary_button_url, item.secondary_button_active) && (
              ...
              {imageLoaded[idx] && (
                <div className="absolute top-0 left-0 right-0 bottom-0 z-10">
                  <div className="mx-auto px-4 py-[40px] sm:py-[60px] md:py-[100px] xl:pt-[170px] md:max-w-5xl md:px-6 md:ml-0 xl:mx-auto">
                    ...
                    {/* Only render button container if at least one button should be shown */}
                    {hasVisibleButtons(item.primary_button_text, item.primary_button_url, item.secondary_button_text, item.secondary_button_url, item.primary_button_active, item.secondary_button_active) && (
                      <div className="flex flex-col min-[376px]:flex-row justify-center items-center md:justify-start gap-3">
                        {shouldShowCarouselButton(item.primary_button_text, item.primary_button_url, item.primary_button_active) && (
                          <LocalizedClientLink
